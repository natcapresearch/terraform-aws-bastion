...
| <a name="input_bucket_packagedir"></a> [bucket\_packagedir](#input\_bucket\_packagedir) | Whether to enable a package directory in the bastion S3 bucket | <pre>object({<br/>    enable = optional(bool, false)<br/>    prefix = optional(string, "packages/")<br/>  })</pre> | `{}` | no |
